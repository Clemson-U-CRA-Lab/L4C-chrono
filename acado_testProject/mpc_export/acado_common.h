 ...
 * 
 *  Matrix containing 10 reference/measurement vectors of size 11 for first 10 nodes.
 */
real_t y[ 110 ];
...
/** Matrix of size: 50 x 2 (row major format) */
real_t evGu[ 100 ];
...
real_t objValueOut[ 88 ];

/** Matrix of size: 50 x 5 (row major format) */
real_t Q1[ 250 ];

/** Matrix of size: 50 x 11 (row major format) */
real_t Q2[ 550 ];

/** Matrix of size: 20 x 2 (row major format) */
real_t R1[ 40 ];

/** Matrix of size: 20 x 11 (row major format) */
real_t R2[ 220 ];
